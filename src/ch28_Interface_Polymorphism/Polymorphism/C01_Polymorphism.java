...
class Sekil {
    ...
    void ciz(){System.out.println("bir sekil cizeceksin");}
    void sekil(){System.out.println("bir sekil cizen method");}
}
class Daire extends Sekil {
    void ciz(){System.out.println("bir daire cizeceksin");}
    void daire(){System.out.println("bir daire cizen method");}
}
class Kare extends Sekil{

    void ciz(){System.out.println("bir kare cizeceksin");}
    void kare(){System.out.println("bir kare cizen method");}
}
