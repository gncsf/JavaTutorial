...
public class C07_ComparingDateTime {
    public static void main(String[] args) {
        ...
        System.out.println("bugun.isBefore(yarin) = " + bugun.isBefore(yarin));
        System.out.println("bugun.isAfter(yarin) = " + bugun.isAfter(yarin));

        System.out.println("dogumGun.isLeapYear() = " + dogumGun.isLeapYear());

        int fark = bugun.compareTo(yarin);

        System.out.println("fark = " + fark);
        System.out.println("bugun.compareTo(dogumGun) = " + bugun.compareTo(dogumGun));
        int fark1 = bugun.compareTo(dogumGun);
